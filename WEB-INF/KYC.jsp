...
response.sendRedirect("KYC.jsp?opn=0&opi=0&opu=0&opd=0&ops=0&aadhar_no="+aadhar_no+"");
}
else if(opi.equals("i"))
{
op="i";
sql="insert into kyc_details values("
        + ""+aadhar_no+",'"+pan_no+"','"+elect_no+"',"
        + "'"+dose1_date+"','"+vaccine_name+"','"+bank_name+"',"
        + "'"+ifsc_code+"','"+bocw_regist+"','"+bank_no+"',"
        +"'"+policy_date+"','"+policy_no+"','"+dose2_date+"','"+branch+"',"
        + "'"+regist_date+"','"+end_date+"')";
...
sql="update kyc_details set "
        + "end_date='"+end_date+"',elect_no='"+elect_no+"',bank_no='"+bank_no+"'"
        + ",vaccine_name='"+vaccine_name+"',policy_no='"+policy_no+"',ifsc_code='"+ifsc_code+"'"
        + ",bank_name='"+bank_name+"',bocw_regist='"+bocw_regist+"',regist_date='"+regist_date+"'"
        +",dose1_date='"+dose1_date+"',pan_no='"+pan_no+"',dose2_date='"+dose2_date+"'"
        +",branch='"+branch+"' where aadhar_no="+aadhar_no+"";
stmt.executeUpdate(sql);
out.println("<script>");
...
response.sendRedirect("KYC.jsp?"
        ...
        + "&aadhar_no="+aadhar_no+"&pan_no="+pan_no+"&elect_no="+elect_no+""
        + "&bank_no="+bank_no+"&bank_name="+bank_name+"&branch="+branch+"&ifsc_code="+ifsc_code+""
        + "&bocw_regist="+bocw_regist+"&regist_date="+regist_date+"&vaccine_name="+vaccine_name+""
        + "&dose1_date="+dose1_date+"&dose2_date="+dose2_date+"&policy_no="+policy_no+""
        + "&policy_date="+policy_date+"&end_date="+end_date+"");
}
else
{
  op="Invalid";
...
+"{"
+"window.location.replace('KYC.jsp?opn=n&opi=0&opu=0&opd=0&ops=0&cust_id=0');"
+"}");
...
+"{"
+"aadhar_no = document.getElementById('aadhar_no').value;"
+"window.location.replace('register.jsp?opn=0&opi=0&opu=0&opd=d&ops=0&aadhar_no='+aadhar_no);"
+"}");

out.println("function search_v()"
+"{"
+"aadhar_no = document.getElementById('aadhar_no').value;"        
+"window.location.replace('KYC.jsp?opn=0&opi=0&opu=0&opd=0&ops=s&aadhar_no='+aadhar_no);"
+"}");
...
+"<a href='about.jsp'>Basic Information</a>"
...
out.println("<tr><td>Electricity Serv No</td><td><input type='text' id='elect_no' name='elect_no'></td></tr>");
...
out.println("<tr><td>Bocw Registration</td><td><input type='text' id='bocw_regist' name='bocw_regist'></td></tr>");
out.println("<tr><td>Registration Date</td><td><input type='text' id='regist_date' name='regist_date'></td></tr>");
out.println("<tr><td>Vaccine Name</td><td><input type='text' id='vaccine_name' name='vaccine_name'></td></tr>");
out.println("<tr><td>Does1 Date</td><td><input type='text' id='does1_date' name='does1_date'></td></tr>");
out.println("<tr><td>Does2 Date</td><td><input type='text' id='does2_date' name='does2_date'></td></tr>");
out.println("<tr><td>Policy No</td><td><input type='text' id='policy_no' name='policy_no'></td></tr>");
out.println("<tr><td>Policy Issue Date</td><td><input type='text' id='policy_date' name='polict_date'></td></tr>");
out.println("<tr><td>Policy End Date</td><td><input type='text' id='end_date' name='end_date'></td></tr>");

out.println("<tr><td align='center'><a href='#' onclick='search_v()'>SEARCH</a></td><td align='center'><a href='#' onclick='insert_v()'>INSERT</a></td></tr>");
